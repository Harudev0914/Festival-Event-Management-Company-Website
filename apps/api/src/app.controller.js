...
let AppController = (() => {
    ...
    (() => {
        ...
        _triggerJob_decorators = [(0, common_1.Get)('trigger-job')];
        _getHealth_decorators = [(0, common_1.UseInterceptors)(cache_manager_1.CacheInterceptor), (0, cache_manager_1.CacheKey)('health-check'), (0, cache_manager_1.CacheTTL)(30), (0, common_1.Get)('health')];
        ...
        __esDecorate(_classThis, null, _triggerJob_decorators, { kind: "method", name: "triggerJob", static: false, private: false, access: { has: obj => "triggerJob" in obj, get: obj => obj.triggerJob }, metadata: _metadata }, null, _instanceExtraInitializers);
