...
exports.MainVisualManager = void 0;
const react_1 = require("react");
const MainVisualManager = () => {
    const [config, setConfig] = (0, react_1.useState)({ imageUrl: '', title: '', subtitle: '' });
    ...
    return (<div style={{ padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
...
exports.MainVisualManager = MainVisualManager;
